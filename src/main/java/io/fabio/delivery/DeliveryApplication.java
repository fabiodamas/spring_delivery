...
import io.fabio.delivery.repository.ClienteRepository;

@SpringBootApplication
public class DeliveryApplication  implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		new Pedido(ID_PEDIDO1, fernando, null, null);

		Pedido pedidoDoFernando = new Pedido(ID_PEDIDO1, fernando, listaPedidoZePequeno1, dog1.getPreco());
